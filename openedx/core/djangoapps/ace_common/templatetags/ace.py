...
def query_random_youtube(noitem):
    ...
    try:
        ...
        for i in videosrandome:
            videoplaylist = videoplaylist + HTML(u'<td class="col" align="center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-spacing: 0; padding: 0 5px; width: 33.33333333%;" width="33.33333333%" valign="top"><a href="https://www.youtube.com/watch?v={0}&list={1}"><img src="https://img.youtube.com/vi/{0}/hqdefault.jpg" width="176" height="auto" /></a></td>').format(HTML(i['snippet']['resourceId']['videoId']),HTML(i['snippet']['playlistId']))
    except:
        videoplaylist = ''
        videoplaylist = videoplaylist + HTML(u'<td class="col" align="center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-spacing: 0; padding: 0 5px; width: 33.33333333%;" width="33.33333333%" valign="top"><a href="https://www.youtube.com/watch?v=vJ3r34ZNXUY&list=PLxOvbcgZ6Vy0ZS06UPrdc-j-SK2EVr8eg"><img src="https://img.youtube.com/vi/vJ3r34ZNXUY/hqdefault.jpg" width="176" height="auto" /></a></td>')
